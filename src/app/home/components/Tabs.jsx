...
const Tabs = ({ content }) => {
  ...
  return (
    <div className="mt-[20px] md:mt-[40px] flex gap-[16px] flex-row text-sm md:text-xl font-semibold font-poppins text-[#222831]">
        ...
        {content &&
          content.map((item, index) => {
            return (
              <div
                key={item.id}
                className="cursor-pointer hover:text-white hover:bg-[#FF5722] p-2 md:p-[14px]"
                onMouseEnter={() =>
